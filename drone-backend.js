...
function fly(robot) {
    ...
    after(10*1000, function(){//this is too stop the drone moving before a further command is given
        bot.drone.right(0);
    });
    after(10*1000, function(){
        bot.drone.back(0.1);
    });
    after(12*1000, function(){//this is too stop the drone moving before a further command is given
        bot.drone.back(0);
    });
    after(12*1000, function(){
        bot.drone.left(0.1);
    });
    after(13*1000, function(){//this is too stop the drone moving before a further command is given
        bot.drone.left(0);
    });
